    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(deleteJob.fulfilled, (state, action) => {
                ...
                state.adminCount = Math.max(
                    0,
                    state.adminCount - 1
                );

                if (
                    state.adminSelectedJob?._id === deletedId
                ) {
                    state.adminSelectedJob = null;
                }
            ...
            .addCase(toggleUrgent.fulfilled, (state, action) => {
                ...
                state.successMessage =
                    action.payload?.message ||
                    "Urgent status updated successfully";
            })
            ...
            .addCase(getJobStats.fulfilled, (state, action) => {
                ...
                state.stats = {
                    totalJobs:
                        action.payload?.data?.totalJobs || 0,

                    featuredJobs:
                        action.payload?.data?.featuredJobs || 0,

                    urgentJobs:
                        action.payload?.data?.urgentJobs || 0,

                    topCategories:
                        action.payload?.data?.topCategories || [],
                };
            })
...
export const selectAdminJobs = (state) =>
    state.jobs.adminJobs;

export const selectAdminSelectedJob = (state) =>
    state.jobs.adminSelectedJob;

export const selectAdminCount = (state) =>
    state.jobs.adminCount;

export const selectAdminLoading = (state) =>
    state.jobs.adminLoading;

export const selectAdminJobLoading = (state) =>
    state.jobs.adminJobLoading;
...
export const selectCategoryJobs = (state) =>
    state.jobs.categoryJobs;

export const selectCategoryName = (state) =>
    state.jobs.categoryName;

export const selectFeaturedJobs = (state) =>
    state.jobs.featuredJobs;

export const selectUrgentJobs = (state) =>
    state.jobs.urgentJobs;
...
export const selectJobTotal = (state) =>
    state.jobs.total;

export const selectJobCount = (state) =>
    state.jobs.count;

export const selectJobPage = (state) =>
    state.jobs.page;

export const selectJobTotalPages = (state) =>
    state.jobs.totalPages;


/* ---------------- LOADING ---------------- */

export const selectJobsLoading = (state) =>
    state.jobs.loading;

export const selectJobLoading = (state) =>
    state.jobs.jobLoading;

export const selectCategoryLoading = (state) =>
    state.jobs.categoryLoading;

export const selectFeaturedLoading = (state) =>
    state.jobs.featuredLoading;

export const selectUrgentLoading = (state) =>
    state.jobs.urgentLoading;

export const selectSearchLoading = (state) =>
    state.jobs.searchLoading;

export const selectStatsLoading = (state) =>
    state.jobs.statsLoading;

export const selectCreateLoading = (state) =>
    state.jobs.createLoading;

export const selectUpdateLoading = (state) =>
    state.jobs.updateLoading;

export const selectDeleteLoading = (state) =>
    state.jobs.deleteLoading;

export const selectStatusLoading = (state) =>
    state.jobs.statusLoading;
...
export const selectJobError = (state) =>
    state.jobs.error;

export const selectCreateError = (state) =>
    state.jobs.createError;

export const selectUpdateError = (state) =>
    state.jobs.updateError;

export const selectDeleteError = (state) =>
    state.jobs.deleteError;

export const selectAdminError = (state) =>
    state.jobs.adminError;

export const selectAdminJobError = (state) =>
    state.jobs.adminJobError;

export const selectSingleJobError = (state) =>
    state.jobs.jobError;

export const selectCategoryError = (state) =>
    state.jobs.categoryError;

export const selectFeaturedError = (state) =>
    state.jobs.featuredError;

export const selectUrgentError = (state) =>
    state.jobs.urgentError;

export const selectSearchError = (state) =>
    state.jobs.searchError;

export const selectStatsError = (state) =>
    state.jobs.statsError;

export const selectStatusError = (state) =>
    state.jobs.statusError;

export const selectFeaturedToggleError = (state) =>
    state.jobs.featuredToggleError;

export const selectUrgentToggleError = (state) =>
    state.jobs.urgentToggleError;
...
export const selectJobSuccessMessage = (state) =>
