...
const Purchases = () => {
  ...
  LOGIN CHECK
  ============================================================
  User logout hai to checkout page se payment karne ke bajay
  login page par redirect hoga.
  */
  ...
  */
  const handlePayment = async () => {
    // Check login before starting payment
    if (!isUserLoggedIn()) {
      navigate("/login", {
        state: {
          from: "/purchases",
              ...
              <div className="p-4 sm:p-7">
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                  <div className="flex items-center gap-4">
                    <div className="flex h-12 w-12 shrink-0 items-center justify-center rounded-2xl border border-[#bfdbfe] bg-gradient-to-br from-[#eff6ff] to-[#dbeafe] text-[#2563eb] shadow-sm sm:h-14 sm:w-14">
